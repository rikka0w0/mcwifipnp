...
public class OfflinePlayerCommand {
    private static final SimpleCommandExceptionType ERROR_ALREADY_IN = new SimpleCommandExceptionType(Component.translatable("commands.whitelist.add.failed"));
    private static final SimpleCommandExceptionType ERROR_NOT_IN = new SimpleCommandExceptionType(Component.translatable("commands.whitelist.remove.failed"));
    ...
    private static int showList(CommandSourceStack commandSourceStack) {
        ...
        if (alwaysOfflinePlayers.size() == 0) {
            ...
            commandSourceStack.sendSuccess(() -> {
                return Component.translatable("commands.whitelist.list", new Object[]{alwaysOfflinePlayers.size(), StringUtils.join(alwaysOfflinePlayers,", ")});
            }, false);
        }
